...
# 		if (math.ceil(challengetime - math.ceil( hours) -1) <1 and (59 - math.ceil(minutes) < 1) and (59 - math.ceil(seconds)) <1):
# 			print("\n")
...
# 			print("You Have Been CODING For => " + str(math.ceil(hours)) + " HOURS : " + str(math.ceil(minutes))  + " MINUTES : "
